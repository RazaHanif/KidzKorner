const blogs = {
    "how-to-choose-a-daycare-in-milton" : {
        ...
        content: [
            ...
            'Cras nulla leo, facilisis ac scelerisque id, blandit non est. Suspendisse lacus ligula, pellentesque id enim eu, fringilla rhoncus nulla. Aenean vel maximus libero. Quisque quis rhoncus lectus. Nulla facilisi. Praesent nec tortor vehicula, fringilla nisl in, dictum neque. Morbi lobortis turpis justo, sit amet pretium nisi aliquam in. Maecenas laoreet a mauris sit amet iaculis. Quisque quis auctor mi, ut vehicula quam. Aenean fringilla massa ex, congue auctor erat finibus sit amet. Aliquam erat volutpat. Suspendisse ac nisi varius eros egestas mollis. Maecenas nec turpis id orci efficitur malesuada sed facilisis tellus. Praesent nec ex ligula. Nullam fermentum, lectus id tincidunt viverra, massa quam eleifend turpis, non facilisis leo nulla sit amet quam. Nam vitae quam porta, imperdiet libero eget, imperdiet libero.',
        ]
    },
    "toddler-activities-in-milton" : {
        title: "Toddler Activities in Milton",
        slug: "toddler-activities-in-milton",
        description: "This will be a quick 5 point list",
