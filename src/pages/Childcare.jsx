        ...
        <div className="flex flex-col justify-center items-center gap-2 w-full">
            ...
            <div className="flex md:flex-row flex-col justify-evenly items-center w-3/4">
                ...
                <div className="flex flex-col justify-center items-center md:w-1/2 w-full">
                    Kidz Korner is a high quality licensed child care centre. Our toddler, preschool, & before/after school programs provides a nurturing, engaging, and stimulating enviroment designed to support your child's growth and development
