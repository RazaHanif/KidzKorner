        ...
        <div className="flex flex-col justify-center items-center gap-2 w-full">
            ...
            <div className="flex md:flex-row flex-col justify-evenly items-center w-3/4">
                ...
                <div className="flex flex-col justify-center items-center md:w-1/2 w-full m-4">
                    ...
                    Our curriculum is guided by the Ministry of Education's <i></i>"How Does Learning Happen?" (HDLH) framework, focusing on the well-being, engagment expression and belonging of each individual child.
                </div>
            </div>
