...
const WinterCamp = () => {
    ...
    const faq = [ 
        ...
        { 
            ...
            a: "Winter Break Camp runs Monday to Friday from 9:00 a.m. to 3:00 p.m. Before- and after-camp care may also be available depending on space. Families interested in extended hours can contact us to ask about availability." 
        }, 
        { 
        ...
        <div className="flex flex-col flex-1 justify-center items-center gap-6 w-full lg:py-16 pb-8">
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10 border-y lg:py-12 py-8 lg:my-12 my-8">
                <h2 className="text-xl font-bold text-center pb-4">
                    Why Families Choose Kidz Korner Winter Break Camp
                </h2>
                    ...
                    <div className="flex flex-col lg:flex-row flex-1 w-full gap-6">
                        ...
                        <Card className="flex-1 flex">
                            <CardHeader className="text-start">
                                ...
                                <CardDescription>
                                    Camp runs from 9:00 a.m. to 3:00 p.m., giving children a full day of activities, play, and social time during their Winter Break.
                                </CardDescription>
                            </CardHeader>
                        </Card>
            ...
            <div className="flex flex-col justify-center items-center gap-6 lg:w-3/4 w-9/10">
                <h2 className="text-xl font-bold text-center pb-4">
                    What to Expect at Kidz Korner Winter Break Camp
                </h2>
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <p className="">
Winter Break Camp runs Monday to Friday from 9:00 a.m. to 3:00 p.m. Our program is limited to 13 children, allowing us to maintain a smaller group environment while campers participate in activities, play together, and make the most of their school break.                    </p>
                    <p className="">
