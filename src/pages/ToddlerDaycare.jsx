                ...
                <div className="flex flex-col justify-center items-center w-full lg:p-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <p className="w-full flex justify-center items-center flex-1">
                            Our toddler program focuses on the important developmental milestones children experience during their early years. Through guided activities and everyday routines, children strengthen communication skills
                        </p>
                    </div>
                </div>
                <Image
