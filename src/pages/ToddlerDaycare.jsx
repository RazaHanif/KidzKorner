...
const ToddlerDaycare = () => {
    ...
    const faq = [
        {
            ...
            a: "Our toddler daycare program is designed for young children between 18 months to 2.5 years.",
        },
        {
    ...
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-6 w-full lg:py-16 pb-8">
            ...
            <div className="flex lg:flex-row flex-col gap-6 lg:w-3/4 w-9/10">
                <div className="flex flex-col flex-1 justify-center items-center w-full py-4 lg:gap-8 gap-6">
                    <p className="flex justify-center items-center lg:w-3/4 lg:text-center">
                        Our toddler daycare program provides a nurturing and
                        engaging environment where young children can explore,
                        learn, and grow with confidence. Through a combination
                        of guided activities, hands-on experiences, and a
                        consistent daily routine, we create a welcoming space
                        where toddlers can feel comfortable while discovering
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10 border-y lg:py-12 py-8 lg:my-12 my-8">
                ...
                <div className="flex lg:flex-row flex-col lg:justify-evenly justify-center items-center w-full">
                    <p className="flex flex-col justify-center items-center w-full text-center">
                        Starting daycare is a big step for both toddlers and
                        their parents. At Kidz Korner, we strive to create a
                        warm and familiar environment where children can feel
                        comfortable as they adjust to a new routine and spend
                        time away from home. Our educators provide consistent
                        guidance throughout the day while creating opportunities
                        for children to explore their surroundings, make
                        choices, and become comfortable with their daily
                        routines. We understand that every child adjusts
                        differently, which is why we take the time to get to
                        know each toddler and provide the reassurance and
                    ...
                    <div className="flex md:flex-row flex-col gap-6">
                        <Card className="flex-1 flex">
                            ...
                            <CardContent className="flex-1 flex justify-end items-end lg:justify-center lg:items-start">
                                Toddlers learn best through exploration. Our
                                activities encourage creativity,
                                problem-solving, and early development skills.
                            </CardContent>
                        </Card>
                        ...
                        <Card className="flex-1 flex">
                            ...
                            <CardContent className="flex-1 flex justify-end items-end lg:justify-center lg:items-start">
                                Arts, crafts, music, and sensory activities help
                                toddlers express themselves and develop new
                                skills.
                            </CardContent>
                        </Card>
                        ...
                        <Card className="flex-1 flex">
                            ...
                            <CardContent className="flex-1 flex justify-end items-end lg:justify-center lg:items-start">
                                Children build friendships and learn important
                                skills like sharing, communication, and
                                cooperation.
                            </CardContent>
                        </Card>
                        ...
                        <Card className="flex-1 flex">
                            ...
                            <CardContent className="flex-1 flex justify-end items-end lg:justify-center lg:items-start">
                                We encourage toddlers to develop confidence
                                through age-appropriate routines and
                                responsibilities.
                            </CardContent>
                        </Card>
                    </div>
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10">
                ...
                <div className="flex lg:flex-row flex-col justify-center items-center w-full gap-6">
                    ...
                    <p className="flex flex-col justify-center items-center w-full text-center">
                        ...
                        throughout the entire day, from following familiar
                        routines and making simple choices to exploring new
                        experiences and participating in age-appropriate
                        activities. Our educators pay attention to each child's
                        interests, abilities, and individual pace, providing
                        encouragement and support as they take on new
                        challenges. This approach helps toddlers become
                        comfortable in their environment while gradually
                        developing the skills they need for their next stage of
                        learning.
                    </p>
            ...
            <title>
                Toddler Daycare in Milton, Ontario | Caring Toddler Program |
                Kidz Korner
            </title>
            <meta
                name="description"
