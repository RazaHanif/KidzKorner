...
const PADayCamp = () => {
    ...
    const faq = [ { q: "What ages does Kidz Korner PA Day Camp serve?", a: "Kidz Korner PA Day Camp is available for the same age range as our regular camp program. Families can contact us to confirm whether their child is eligible for the current PA Day program." }, { q: "What are the hours for PA Day Camp?", a: "PA Day Camp runs from 9:00 a.m. to 3:00 p.m. Before- and after-camp care may also be available depending on space. Families interested in extended hours can contact us to ask about availability." }, { q: "How much does PA Day Camp cost?", a: "PA Day Camp is $45 per child per day. The daily price includes the regular camp activities and programming offered throughout the day." }, { q: "What activities are offered at PA Day Camp?", a: "Children participate in a variety of activities throughout the day, including arts and crafts, games, sports, creative activities, free play, indoor playground time, and other fun camp activities." }, { q: "Does PA Day Camp include indoor playground time?", a: "Yes. Children have access to Kidz Korner's indoor playground as part of the PA Day Camp program. Indoor play gives children plenty of opportunities to stay active and have fun throughout the day." }, { q: "How many children are in PA Day Camp?", a: "PA Day Camp is currently limited to a maximum of 13 children. Keeping the program small allows children to participate comfortably in activities and enjoy a more manageable group environment." }, { q: "What should my child bring to PA Day Camp?", a: "Children should bring a nut-free packed lunch, snacks, a reusable water bottle, comfortable clothing, indoor shoes, and any personal items they may need throughout the day. We recommend labeling personal belongings with your child's name." }, ]
