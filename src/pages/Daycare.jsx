...
const Daycare = () => {
    ...
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-6 w-full lg:py-16 pb-8">
            ...
            <div className="flex flex-col justify-center lg:w-3/4 w-9/10">
                <Card>
                    <CardHeader>
                        <CardTitle className="p-2 bg-primary text-primary-foreground flex justify-center items-center rounded-md text-lg">
                            What We Offer!
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10 gap-2 border-t lg:py-12 py-8 lg:my-12 my-8">
                <h2>
