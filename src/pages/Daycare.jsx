...
const Daycare = () => {
    ...
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-4 w-full lg:py-16 pb-8">
            ...
            <div className="flex lg:flex-row flex-col justify-between items-center lg:w-3/4 w-9/10 gap-4 lg:py-16 py-8">
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10 lg:py-16 py-8">
            ...
            <div className="flex flex-col justify-center lg:w-3/4 w-9/10 lg:py-16 py-8">
                <Card>
                    <CardHeader>
                        <CardTitle className="p-2 bg-primary text-primary-foreground flex justify-center items-center rounded-md text-lg">
                            What We Offer!
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10 gap-1 m-4 overflow-x-auto lg:py-16 py-8">
