...
const BlogSlug = () => {
    ...
    return (
        <div className="flex flex-col flex-1 justify-start items-center gap-6 w-full lg:py-16 pb-8">
            ...
            <article className="flex flex-2 flex-col justify-center items-center w-full border">
