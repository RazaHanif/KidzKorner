        ...
        <div className="flex flex-col flex-1 justify-center items-center gap-4 w-full lg:py-16 pb-8">
            ...
            <div className="flex flex-col justify-center items-center gap-4 lg:py-16 py-8">
                ...
                <div className="flex lg:flex-row flex-col justify-center lg:items-stretch items-center lg:w-full w-3/4 gap-4">
                    ...
                    <Image src='/20250711_111518.jpg' alt='Child Playing With Dinosaurs at Kidz Korner Milton, Ontario' className="w-full" />
                </div>
            </div>
            ...
            <title>
                Kids Camps in Milton | Summer, March Break & PA Day Camps | Kidz Korner
            </title>
