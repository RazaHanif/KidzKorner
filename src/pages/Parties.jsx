        ...
        <div className="flex flex-col justify-center items-center w-full gap-2">
            ...
            <div className="flex flex-col justify-center items-center w-3/4 gap-4">
                ...
                <div className="flex lg:flex-row flex-col p-2 gap-2">
                    <div className="flex flex-col gap-2 w-full flex-1">
                        <p className="flex items-start gap-3">
                            <Dot className="mt-1 h-5 w-10 shrink-0 text-primary"/> 1st Birthdays
                        </p>
                        <p className="flex items-start gap-3">
                            <Dot className="mt-1 h-5 w-10 shrink-0 text-primary"/> 2nd Birthdays
                        </p>
                        <p className="flex items-start gap-3">
                            <Dot className="mt-1 h-5 w-10 shrink-0 text-primary"/> Preschool Birthdays
                        </p>
                        <p className="flex items-start gap-3">
                            <Dot className="mt-1 h-5 w-10 shrink-0 text-primary"/> Kindergarten Birthdays
                        </p>
                    </div>
                    <div className="flex flex-col gap-2 w-full flex-1">
                        <p className="flex items-start gap-3">
                            <Dot className="mt-1 h-5 w-10 shrink-0 text-primary"/> School-aged Children
                        </p>
                        <p className="flex items-start gap-3">
                            <Dot className="mt-1 h-5 w-10 shrink-0 text-primary"/> Family Celebrations
                        </p>
                        <p className="flex items-start gap-3">
                            <Dot className="mt-1 h-5 w-10 shrink-0 text-primary"/> Winter Birthdays Parties
                        </p>
                        <p className="flex items-start gap-3">
                            <Dot className="mt-1 h-5 w-10 shrink-0 text-primary"/> Rainy Day Birthdays Parties
                        </p>
                    </div>
                </div>
            </div>
