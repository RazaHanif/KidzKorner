...
const Playground = () => {
    ...
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-4 w-full lg:py-16 pb-8">
            ...
            <div className="flex flex-col justify-center items-center w-full border-y-2 p-4">
                <p className="flex lg:flex-row flex-col justify-center items-center lg:text-justify text-center w-3/4">
                    ...
                    Kidz Korner offers a safe and engaging indoor play space designed for toddlers and young children. Come on in to escape from the heat, cold, rain or snow.
                </p>
            </div>
