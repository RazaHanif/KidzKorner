...
const Playground = () => {
    ...
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-4 w-full lg:py-16 pb-8">
            ...
            <div className="flex lg:flex-row flex-col justify-center items-center w-3/4 lg:pt-16 pt-8">
                <Image src='/20250930_142748.jpg' alt="Children playing on the indoor playground at Kidz Korner in Milton Ontario" />
