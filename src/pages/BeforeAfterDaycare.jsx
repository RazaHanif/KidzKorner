    ...
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-4 w-full lg:py-16 pb-8">
            ...
            <div className="flex flex-col justify-center items-center w-3/4 m-4">
                ...
                <div className="flex flex-col lg:justify-evenly justify-center items-center w-full">
                    <div className="flex flex-col justify-center m-4 lg:m-0 flex-2">
                        <Table>
                            <TableBody>
                                <TableRow>
                    ...
                    <div className="flex flex-col justify-center items-center border lg:w-3/4 w-full">
                        <p className="">
