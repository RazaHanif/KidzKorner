...
const BeforeAfterDaycare = () => {
    ...
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-6 w-full lg:py-16 pb-8">
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-5/6">
            ...
            <div className="flex flex-col justify-center items-center w-3/4 border-y lg:py-12 py-8 lg:my-12 my-8">
                <h2 className="text-xl font-bold text-center pb-4">
