...
import { BadgeCheck, GraduationCap, HeartHandshake, MessageCircleHeart, Palette, ShieldCheck } from "lucide-react";
...
const Home = () => {
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-6 w-full lg:py-16 pb-8">
            ...
            <div className="flex flex-col justify-center items-center w-full lg:text-justify text-center">
                <div className="flex lg:flex-row flex-col justify-center items-center lg:w-3/4 w-9/10 gap-6">
                    <Image
                    ...
                    <div className="flex flex-col justify-center items-center w-full lg:p-4">
                        ...
                        <div className="flex flex-col gap-6 w-full">
                            <p className="w-full flex justify-center items-center flex-1">
                                Kidz Korner is proud to serve Milton families with high-quality licensed childcare in a convenient and accessible location. 
                                Situated near Highway 401 and just minutes from downtown Milton, our daycare makes daily drop-offs and pick-ups easy for busy parents commuting throughout the area, located conveniently near the Milton Go Station.
                            </p>

                            <p className="w-full flex justify-center items-center flex-1">
                                We welcome children from neighborhoods across Milton, including Clarke, Scott, Willmott, Beaty, Harrison, Dempsey, Timberlea, and surrounding communities throughout the Halton Region. 
                ...
                <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10 p-4">
                    <h2 className="w-full flex justify-center items-center m-4 font-bold text-xl flex-1">
