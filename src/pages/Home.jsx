    ...
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-4 w-full lg:py-16 pb-8">
            ...
            <div className="flex flex-col justify-center items-center w-full lg:text-justify text-center">
                <div className="flex lg:flex-row flex-col justify-center items-center gap-4 lg:w-3/4 w-9/10">
                    <Image
                ...
                <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10 py-16">
