            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-full lg:text-justify text-center">
                <div className="flex lg:flex-row flex-col justify-center items-center gap-4">
                    ...
                    <div className="flex flex-col justify-center items-center w-full lg:p-4">
                        ...
                        <div className="w-full flex lg:flex-col gap-4 justify-center lg:items-end lg:pr-4 items-center border-2">
                            <NavLink 
                                to="/about" 
                                end
                                className="hover:scale-105 ease-in-out duration-300 flex-1 border-1 lg:w-3/4 flex justify-center lg:justify-end"
                            >
