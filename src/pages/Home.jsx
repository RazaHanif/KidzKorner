                ...
                <div className="flex lg:flex-row flex-col justify-center items-center gap-4">
                    ...
                    <div className="flex flex-col justify-center items-center w-full p-4">
                        ...
                        <p className="w-full flex justify-center items-center m-4 flex-1">
                            ...
                            We offer daycare for toddlers and preschoolers in Milton, before and after school care, and licensed school-age camps
                            designed to support children at every stage of
