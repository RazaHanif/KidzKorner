            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-full lg:text-justify text-center">
                <div className="flex lg:flex-row flex-col justify-center items-center gap-4">
                    ...
                    <div className="flex flex-col justify-center items-center w-full p-4">
                        ...
                        <p className="w-full flex justify-center items-center m-4 flex-1">
                            ...
                            We offer daycare for toddlers and preschoolers in Milton, before and after school care, and licensed school-age camps designed to support children at every stage of
                            development. Our camps are available during PA/PD
                            days, March Break, Summer Break, and Winter Break.
                ...
                <div className="flex flex-col justify-center items-center lg:w-3/4 w-full lg:text-justify text-center">
                    <div className="flex flex-col justify-center items-center w-full p-4">
                        ...
                        <p className="w-full flex justify-center items-center m-4 flex-1">
                            Kidz Korner welcomes families from across Milton,
                            ...
                            close to home. serving Milton families located near
                            Highway 401 close to downtown Milton serving
                            families throughout Halton Region
                        </p>
                    ...
                    <div className="flex flex-col justify-center items-center w-full p-4">
                        ...
                        <p className="w-full flex justify-center items-center m-4 flex-1">
                            We proudly offer Toddler Daycare, Preschool, Before
                            & After School Care, Summer Camps, March Break
                            Camps, and PA Day Programs for Milton families.
                            Every program combines structured learning, creative
                            play, outdoor activities, and opportunities to build
                            friendships in a safe and supportive environment.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col justify-center items-center w-full p-4">
                        ...
                        <p className="w-full flex justify-center items-center m-4 flex-1">
                            ...
                            regulated environment. Licensed childcare centres in
                        ...
                        <p className="w-full flex justify-center items-center m-4 flex-1">
                            At Kidz Korner, we follow Ontario's licensed
                            childcare standards while delivering a play-based
                            curriculum that supports every child's development.
