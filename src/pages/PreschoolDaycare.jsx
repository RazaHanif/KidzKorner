...
const PreschoolDaycare = () => {
    ...
    return (
        <div className="flex flex-col flex-1 justify-center items-center gap-6 w-full lg:py-16 pb-8">
            ...
            <div className="flex lg:flex-row flex-col gap-6 lg:w-3/4 w-9/10">
                <div className="flex flex-col flex-1 justify-center items-center w-full py-4 lg:gap-8 gap-6">
                    <p className="flex justify-center items-center lg:text-center">
                        Our preschool program in Milton gives children the
                        space, support, and encouragement they need to become
                        confident and independent learners. Through hands-on
                        activities, creative play, social experiences, and daily
                        routines, children are encouraged to explore their
                        interests while developing important skills for their
                        next stage of learning. Our caring educators create a
                        welcoming environment where preschoolers can build
                        friendships, express themselves, solve problems, and
                        learn at their own pace. We believe preschool should be
                        more than preparing children for what comes next—it
                        should be a place where they feel comfortable trying new
                        things, asking questions, and discovering what they can
                        do. At Kidz Korner, we combine play, learning, and
                        meaningful relationships to help your child grow in
                        confidence and independence while enjoying their
                        preschool years.
                    </p>
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10  lg:pt-12 pt-8 lg:mt-12 mt-8">
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10 border-y lg:py-12 py-8 lg:my-12 my-8">
                ...
                <div className="flex flex-1 flex-col gap-6 w-full">
                    <div className="flex md:flex-row flex-col gap-6">
                        <Card className="flex-1 flex">
                            <CardHeader className="text-start">
                                <CardTitle>Growing Independence</CardTitle>
                            </CardHeader>
                            <CardContent className="flex-1 flex justify-end items-end lg:justify-center lg:items-start">
                                Preschoolers are encouraged to make choices,
                                take on age-appropriate responsibilities, and
                                become more confident in doing things for
                                themselves.
                            </CardContent>
                        </Card>
                        ...
                        <Card className="flex-1 flex">
                            ...
                            <CardContent className="flex-1 flex justify-end items-end lg:justify-center lg:items-start">
                                Children learn best when they're engaged and
                                having fun. Play gives preschoolers
                                opportunities to explore, experiment, create,
                    ...
                    <div className="flex md:flex-row flex-col gap-6">
                        <Card className="flex-1 flex">
                            <CardHeader className="text-start">
                                <CardTitle>Building Social Skills</CardTitle>
                            </CardHeader>
                            <CardContent className="flex-1 flex justify-end items-end lg:justify-center lg:items-start">
                                Through group activities and everyday
                                interactions, children learn to communicate,
                                cooperate, build friendships, and navigate new
                                social experiences.
                            </CardContent>
                        </Card>
                        ...
                        <Card className="flex-1 flex">
                            <CardHeader className="text-start">
                                <CardTitle>Developing Confidence</CardTitle>
                            </CardHeader>
                            <CardContent className="flex-1 flex justify-end items-end lg:justify-center lg:items-start">
                                With encouragement from caring educators,
                                children are supported in trying new things,
                                expressing themselves, and taking pride in what
                                they can accomplish.
                            </CardContent>
                        </Card>
                    </div>
            ...
            <div className="flex flex-col justify-center items-center lg:w-3/4 w-9/10">
                ...
                <div className="flex flex-col gap-6 lg:justify-evenly justify-center items-center w-full">
                    <p className="flex flex-col justify-center items-center w-full text-center">
                        The preschool years are an exciting time of growing
                        independence, curiosity, and self-discovery. Children
                        are developing new ways to communicate, interact with
                        others, solve problems, and understand the world around
                        them. At Kidz Korner, we provide experiences that
                        support these areas of development through play,
                        hands-on activities, creative expression, and everyday
                        interactions. Our educators encourage children to
                        explore, ask questions, make choices, and take on new
                        challenges while providing the guidance and reassurance
                                ...
                                <CardContent className="flex md:flex-row flex-col gap-2">
                                    <div className="flex flex-col flex-1 gap-2">
                                        <div className="flex flex-col items-start justify-start w-full">
                                            ...
                                            <p className="text-start pl-8">
                                                Children learn to recognize and
                                                express their feelings, build
                                                friendships, cooperate with
                                                others, and develop the
                                        ...
                                        <div className="flex flex-col items-start justify-start w-full">
                                            ...
                                            <p className="text-start pl-8">
                                                Stories, conversations, songs,
                                                and everyday interactions help
                                                children expand their
                                                vocabulary, express their ideas,
                                                listen to others, and become
                                    ...
                                    <div className="flex flex-col flex-1 gap-2">
                                        <div className="flex flex-col items-start justify-start w-full">
                                            ...
                                            <p className="text-start pl-8">
                                                Active play and hands-on
                                                activities help children build
                                                coordination, balance,
                                                fine-motor skills, and body
                                                awareness.
                                            </p>
                                        </div>
                                        <div className="flex flex-col items-start justify-start w-full">
                                            ...
                                            <p className="text-start pl-8">
                                                Art, music, imaginative play,
                                                and creative activities give
                                                children opportunities to
                                                express themselves and explore
                                                their own ideas.
                                            </p>
                                        </div>
                                        <div className="flex flex-col items-start justify-start w-full">
            ...
            <title>
                Preschool Daycare in Milton, Ontario | Learning Through Play |
                Kidz Korner
            </title>
            <meta
                name="description"
                content="Explore Kidz Korner's preschool daycare in Milton, where children learn through play, build independence, develop friendships, and grow in confidence."
            />
            <meta
                property="og:title"
            ...
            <meta
                property="og:url"
                content="https://www.kidzkornermilton.com/daycare/preschool"
            />
            <meta
                property="og:image"
