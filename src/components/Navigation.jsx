            ...
            <NavigationMenuList>
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        ...
                        <NavigationMenuLink onClick={() => navigate('/daycare/before-after-school')}>
                            Before & After School
                        </NavigationMenuLink>
                    </NavigationMenuContent>
                </NavigationMenuItem>
                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        ...
                        <NavigationMenuLink onClick={() => navigate('/camp/march-break')}>
                            March Break Camp
                        </NavigationMenuLink>
                        <NavigationMenuLink onClick={() => navigate('/camp/winter-break')}>
                            Winter Break Camp
                        </NavigationMenuLink>
                        <NavigationMenuLink onClick={() => navigate('/camp/pa-day')}>
                            PA Day Camp
                        </NavigationMenuLink>
                    </NavigationMenuContent>
                </NavigationMenuItem>
